...
STEP_TOOL_NEEDS = {
    ...
    "research": ["web_search", "web_fetch", "web_reader", "gh_api", "rss_read",
                 "youtube_transcript", "fs_read", "fs_write"],
    "validate_sources": ["web_fetch", "web_reader", "gh_api", "fs_read", "fs_write"],
